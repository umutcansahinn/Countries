package com.umutcansahin.countries.view
...
import com.umutcansahin.countries.databinding.FragmentCountryBinding
import com.umutcansahin.countries.util.downloadFromUrl
import com.umutcansahin.countries.util.placeholderProgressBar
import com.umutcansahin.countries.viewmodel.CountryViewModel
    ...
    private fun observeLiveData() {
        viewModel.countryLiveData.observe(viewLifecycleOwner, Observer { country ->
            country?.let {
                ...
                context?.let { context ->
                    countryImage.downloadFromUrl(it.flag, placeholderProgressBar(context))
                }
                */
            }
        })
